...
$ make
make -C /lib/modules/4.13.0-36-generic/build M=/home/colby/work300GB/cbx-study/linux-kernel/module/12.proc文件系统 modules
...
root@colby-myntai:~# echo caobinxin_1 > /proc/proc_seq
root@colby-myntai:~# cat /proc/proc_seq
List has 1 items, total 12 bytes
caobinxin_1
root@colby-myntai:~# echo caobinxin_2 > /proc/proc_seq
root@colby-myntai:~# echo caobinxin_3 > /proc/proc_seq
root@colby-myntai:~# cat /proc/proc_seq
List has 3 items, total 36 bytes
caobinxin_1
caobinxin_2
caobinxin_3
root@colby-myntai:~# rmmod proc_test04
root@colby-myntai:~#
